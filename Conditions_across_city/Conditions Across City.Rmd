...
report5hrs_plot2 <- ggplot(report5hrs_sum, mapping = aes(x = reorder(name,-damage), y = damage)) +
  ...
  coord_flip() +
  facet_wrap(~resource) +
  labs(title = "Average Damage Rating per Resource Categories in 5hrs after Earthquake", y = "Damage Rating", x = "Location")
...
report30hrs_plot2 <- ggplot(report30hrs_sum, mapping = aes(x = reorder(name,-damage), y = damage)) + #reorder(name, -location) to order by location
  ...
  coord_flip() +
  facet_wrap(~resource) +
  labs(title = "Average Damage Rating per Resource Categories in 30hrs after Earthquake", y = "Damage Rating", x = "Location") 
